...
DRIVE_STATUS_SCHEMA = {
    ...
    "properties": {
        ...
        "range_rejected": {"type": "integer", "description": "boxes that matched on BEARING and were then rejected because the bbox-height range disagreed with the lidar. The other half of why a cone the camera plainly saw carries no label -- unmatched_in_fov is the bearing half"},
...
def status_of(result, cones, filled, line, pursuit, duty, servo, armed, args,
    ...
    return {
        ...
        "range_rejected": result.range_rejected,
