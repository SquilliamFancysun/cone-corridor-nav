...
The pure packages live under src/. Nothing here builds or installs them --
the README's promise is that `pytest` works on a laptop with no ROS, and this
...
for _rel in ("src", "model/capture", "analysis", "."):
